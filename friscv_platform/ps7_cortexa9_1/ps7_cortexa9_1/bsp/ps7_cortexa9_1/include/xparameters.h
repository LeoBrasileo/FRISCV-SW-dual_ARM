...
/* Definitions for peripheral AXI_GPIO_CLK_GEN */
#define XPAR_AXI_GPIO_CLK_GEN_BASEADDR 0x41260000
#define XPAR_AXI_GPIO_CLK_GEN_HIGHADDR 0x4126FFFF
#define XPAR_AXI_GPIO_CLK_GEN_DEVICE_ID 0
#define XPAR_AXI_GPIO_CLK_GEN_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_CLK_GEN_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_DEBUG */
#define XPAR_AXI_GPIO_DEBUG_BASEADDR 0x41250000
#define XPAR_AXI_GPIO_DEBUG_HIGHADDR 0x4125FFFF
#define XPAR_AXI_GPIO_DEBUG_DEVICE_ID 1
#define XPAR_AXI_GPIO_DEBUG_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_DEBUG_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_DEBUG_MEM_ADDR */
#define XPAR_AXI_GPIO_DEBUG_MEM_ADDR_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_DEBUG_MEM_ADDR_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_DEBUG_MEM_ADDR_DEVICE_ID 2
#define XPAR_AXI_GPIO_DEBUG_MEM_ADDR_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_DEBUG_MEM_ADDR_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_DEBUG_MEM_DATA */
#define XPAR_AXI_GPIO_DEBUG_MEM_DATA_BASEADDR 0x41220000
#define XPAR_AXI_GPIO_DEBUG_MEM_DATA_HIGHADDR 0x4122FFFF
#define XPAR_AXI_GPIO_DEBUG_MEM_DATA_DEVICE_ID 3
#define XPAR_AXI_GPIO_DEBUG_MEM_DATA_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_DEBUG_MEM_DATA_IS_DUAL 1
...
#define XPAR_AXI_GPIO_RST_N_EXTERN_DEVICE_ID 4
...
/* Canonical definitions for peripheral AXI_GPIO_CLK_GEN */
#define XPAR_GPIO_0_BASEADDR 0x41260000
#define XPAR_GPIO_0_HIGHADDR 0x4126FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_CLK_GEN_DEVICE_ID
...
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_DEBUG_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 1

/* Canonical definitions for peripheral AXI_GPIO_DEBUG_MEM_ADDR */
#define XPAR_GPIO_2_BASEADDR 0x41200000
#define XPAR_GPIO_2_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_DEBUG_MEM_ADDR_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_DEBUG_MEM_DATA */
#define XPAR_GPIO_3_BASEADDR 0x41220000
#define XPAR_GPIO_3_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_AXI_GPIO_DEBUG_MEM_DATA_DEVICE_ID
...
#define XPAR_GPIO_4_DEVICE_ID XPAR_AXI_GPIO_RST_N_EXTERN_DEVICE_ID
