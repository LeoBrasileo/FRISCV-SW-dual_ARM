...
/* Definitions for peripheral AXI_GPIO_CLK_GEN_N_DEBUG */
#define XPAR_AXI_GPIO_CLK_GEN_N_DEBUG_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_CLK_GEN_N_DEBUG_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_CLK_GEN_N_DEBUG_DEVICE_ID 0
#define XPAR_AXI_GPIO_CLK_GEN_N_DEBUG_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_CLK_GEN_N_DEBUG_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_D_MEM_ADDR */
#define XPAR_AXI_GPIO_D_MEM_ADDR_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_D_MEM_ADDR_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_D_MEM_ADDR_DEVICE_ID 1
#define XPAR_AXI_GPIO_D_MEM_ADDR_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_D_MEM_ADDR_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_D_MEM_CTRL */
#define XPAR_AXI_GPIO_D_MEM_CTRL_BASEADDR 0x41220000
#define XPAR_AXI_GPIO_D_MEM_CTRL_HIGHADDR 0x4122FFFF
#define XPAR_AXI_GPIO_D_MEM_CTRL_DEVICE_ID 2
#define XPAR_AXI_GPIO_D_MEM_CTRL_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_D_MEM_CTRL_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_D_MEM_DATA */
#define XPAR_AXI_GPIO_D_MEM_DATA_BASEADDR 0x41250000
#define XPAR_AXI_GPIO_D_MEM_DATA_HIGHADDR 0x4125FFFF
#define XPAR_AXI_GPIO_D_MEM_DATA_DEVICE_ID 3
#define XPAR_AXI_GPIO_D_MEM_DATA_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_D_MEM_DATA_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_I_MEM_CTRL */
#define XPAR_AXI_GPIO_I_MEM_CTRL_BASEADDR 0x41260000
#define XPAR_AXI_GPIO_I_MEM_CTRL_HIGHADDR 0x4126FFFF
#define XPAR_AXI_GPIO_I_MEM_CTRL_DEVICE_ID 4
#define XPAR_AXI_GPIO_I_MEM_CTRL_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_I_MEM_CTRL_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_I_MEM_DATA */
#define XPAR_AXI_GPIO_I_MEM_DATA_BASEADDR 0x41230000
#define XPAR_AXI_GPIO_I_MEM_DATA_HIGHADDR 0x4123FFFF
#define XPAR_AXI_GPIO_I_MEM_DATA_DEVICE_ID 5
#define XPAR_AXI_GPIO_I_MEM_DATA_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_I_MEM_DATA_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_RST_N_EXTERN */
#define XPAR_AXI_GPIO_RST_N_EXTERN_BASEADDR 0x41240000
#define XPAR_AXI_GPIO_RST_N_EXTERN_HIGHADDR 0x4124FFFF
#define XPAR_AXI_GPIO_RST_N_EXTERN_DEVICE_ID 6
#define XPAR_AXI_GPIO_RST_N_EXTERN_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_RST_N_EXTERN_IS_DUAL 1


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_CLK_GEN_N_DEBUG */
#define XPAR_GPIO_0_BASEADDR 0x41210000
#define XPAR_GPIO_0_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_CLK_GEN_N_DEBUG_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 1

/* Canonical definitions for peripheral AXI_GPIO_D_MEM_ADDR */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_D_MEM_ADDR_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_D_MEM_CTRL */
#define XPAR_GPIO_2_BASEADDR 0x41220000
#define XPAR_GPIO_2_HIGHADDR 0x4122FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_D_MEM_CTRL_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 1

/* Canonical definitions for peripheral AXI_GPIO_D_MEM_DATA */
#define XPAR_GPIO_3_BASEADDR 0x41250000
#define XPAR_GPIO_3_HIGHADDR 0x4125FFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_AXI_GPIO_D_MEM_DATA_DEVICE_ID
#define XPAR_GPIO_3_INTERRUPT_PRESENT 0
#define XPAR_GPIO_3_IS_DUAL 1

/* Canonical definitions for peripheral AXI_GPIO_I_MEM_CTRL */
#define XPAR_GPIO_4_BASEADDR 0x41260000
#define XPAR_GPIO_4_HIGHADDR 0x4126FFFF
#define XPAR_GPIO_4_DEVICE_ID XPAR_AXI_GPIO_I_MEM_CTRL_DEVICE_ID
#define XPAR_GPIO_4_INTERRUPT_PRESENT 0
#define XPAR_GPIO_4_IS_DUAL 0

/* Canonical definitions for peripheral AXI_GPIO_I_MEM_DATA */
#define XPAR_GPIO_5_BASEADDR 0x41230000
#define XPAR_GPIO_5_HIGHADDR 0x4123FFFF
#define XPAR_GPIO_5_DEVICE_ID XPAR_AXI_GPIO_I_MEM_DATA_DEVICE_ID
#define XPAR_GPIO_5_INTERRUPT_PRESENT 0
#define XPAR_GPIO_5_IS_DUAL 1

/* Canonical definitions for peripheral AXI_GPIO_RST_N_EXTERN */
#define XPAR_GPIO_6_BASEADDR 0x41240000
#define XPAR_GPIO_6_HIGHADDR 0x4124FFFF
#define XPAR_GPIO_6_DEVICE_ID XPAR_AXI_GPIO_RST_N_EXTERN_DEVICE_ID
